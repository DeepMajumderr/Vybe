        ...
        <div className='w-full min-h-[100vh] bg-black flex items-center flex-col gap-[20px] '>
            ...
            <div className='w-full h-[80px] flex items-center justify-center mt-[80px]'>
                <div className='w-[90%] max-w-[800px] h-[80%] rounded-full bg-[#0f1414] flex items-center px-[20px]' >
                    ...
                    <input type="text" placeholder='search...' className='w-full h-full outline-0 rounded-full px-[20px] text-white text-[18px] cursor-pointer' onChange={(e) => setInput(e.target.value)} value={input} />
                </div>
            </div>
            ...
            {!input && <div className='text-[30px] text-gray-700 font-bold cursor-pointer'>Search Here...</div>}
