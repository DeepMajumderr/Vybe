    ...
    return (
        ...
        <div className='w-full h-[100vh] bg-black relative'>
            ...
            bg-black  z-[100]'>
                ...
                items-center gap-[10px] px-[20px] relative" onSubmit={handleSendMessage}>

                    {frontendImage &&
                        <div className='w-[100px] rounded-2xl h-[100px] absolute top-[-120px] right-[10px]
                    overflow-hidden'>
                    ...
                    <div onClick={() => imageInput.current.click()}>
                        <IoImage className='w-[28px] h-[28px] text-white cursor-pointer' />
                    </div>

                    {(input || frontendImage) &&
                        <button className='w-[60px] h-[40px] rounded-full bg-gradient-to-br from-[#9500ff] to-[#ff0095] 
