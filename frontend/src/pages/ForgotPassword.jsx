...
const ForgotPassword = () => {
    ...
    flex flex-col justify-center items-center'>
            ...
            {
                step == 1 &&
                <div className='w-[90%] max-w-[500px] h-[500px]
                ...
                flex-col border-[#1a1f23]'>
                    ...
                    <div className='relative flex items-center mt-[30px] justify-start w-[90%] 
                        ...
                        <label htmlFor='otp' className={`text-gray-700 absolute left-[20px]
                            p-[5px] bg-white text-[15px] ${inputClicked.otp ? "top-[-15px]" : ""}`}>
                            Enter OTP
                        </label>
                        <input onChange={(e) => setotp(e.target.value)}
                            value={otp}
                            type="text" id='otp' className='w-[100%] h-[100%]
                            rounded-2xl px-[20px] outline-none border-0 required' />
                    </div>
...

            {
                ...
                flex-col border-[#1a1f23]'>
                    ...
                    <div className='relative flex items-center mt-[30px] justify-start w-[90%] 
                        ...
                        <label htmlFor='newPassword' className={`text-gray-700 absolute left-[20px]
                            p-[5px] bg-white text-[15px] ${inputClicked.newPassword ? "top-[-15px]" : ""}`}>
                            Enter New Password
                        </label>
                        <input onChange={(e) => setnewPassword(e.target.value)}
                            value={newPassword}
                            type="text" id='newPassword' className='w-[100%] h-[100%]
                            rounded-2xl px-[20px] outline-none border-0 required' />
                    </div>
                    ...
                    <div className='relative flex items-center mt-[30px] justify-start w-[90%] 
                        ...
                        <label htmlFor='confirmNewPassword' className={`text-gray-700 absolute left-[20px]
                            p-[5px] bg-white text-[15px] ${inputClicked.confirmNewPassword ? "top-[-15px]" : ""}`}>
                            Confirm New Password
                        </label>
                        <input onChange={(e) => setconfirmNewPassword(e.target.value)}
                            value={confirmNewPassword}
                            type="text" id='confirmNewPassword' className='w-[100%] h-[100%]
                            rounded-2xl px-[20px] outline-none border-0 required' />
                    </div>
